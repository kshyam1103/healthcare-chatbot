...
class ChatInterface(Frame):
    ...
    def msg(self):
        tkinter.messagebox.showinfo("medbot v1.1",'medbot is a chatbot for Making health related conversations\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer questions related to healthcare')

    def about(self):
        tkinter.messagebox.showinfo("medbot Developer\n","K SHYAM")
...
root.title("medbot- healthcare Chatbot")
